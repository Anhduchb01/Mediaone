<?php
    $sql_sua_sp = "SELECT * FROM tbl_cd WHERE id_sanpham='$_GET[idsanpham]' LIMIT 1";
...
?>  
<form method="POST" action="./modules/quanlysp/xulydianhac.php?idsanpham=<?php echo $_GET['idsanpham']?>" enctype="multipart/form-data"> <!-- muon gui hinh anh qua post pha them enctype -->
        <tr>
        ...
        <tr>
            ...
            <td class="them_menu2"><input type="text" value="<?php echo $row['nghesi'] ?>" name="nghesi"></td>
        </tr>
        <tr>
            <td class="them_menu1">Nhà sản xuất</td>
            <td class="them_menu2"><input type="text" value="<?php echo $row['nhasx'] ?>" name="nhasx"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="them_menu2"><input type="text" value="<?php echo $row['gernes1'] ?>" name="gernes1"></td>
        </tr>
        <tr>
