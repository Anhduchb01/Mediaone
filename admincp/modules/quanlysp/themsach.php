<div class="quanlymenu">
            <h3>thêm sách</h3>
            <form method="POST" action="./modules/quanlysp/xulycsvsach.php" enctype="multipart/form-data">
            ...
            <table class='them_menu'>
                <form method="POST" action="./modules/quanlysp/xulysach.php" enctype="multipart/form-data"> 
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="them_menu2"><input type="text" name="tacgia"></td>
                    </tr>
                    <tr>
                        <td  class="them_menu1">Nhà phát hành</td>
                        <td class="them_menu2"><input type="text" name="nhahathanh"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="them_menu2"><input type="text" name="trang"></td>
                    </tr>
                    <tr>
