<?php
    ...
    $sql_lietke_sp ="SELECT * FROM tbl_book ORDER BY id_sanpham ASC
    ";
...
<div class="quanlymenu">
            ...
            <table class='lietkesp' >
                    ...
                    <tr>
                        ...
                        <th><?php echo $row['nhaphathanh'] ?></th>
                        ...
                        <th>
                            <a href="modules/quanlysp/xulysach.php?idsanpham=<?php echo $row['id_sanpham']?>">Xóa</a>  |  <a href="index.php?action=quanlysp&query=suasach&idsanpham=<?php echo $row['id_sanpham']?>">Sửa</a> 
                        </th>
                    </tr>
                    <?php
                        }
