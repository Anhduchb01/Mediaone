...
//su li hinh anh
    ...
    if(isset($_POST['thembaibao'])){
        //them
        $sql_them = "INSERT INTO tbl_baibao(tenbaibao,hinhanh,thoigian,tomtat,noidung,tinhtrang,thutu) VALUE('".$tenbaibao ."','".$hinhanh."','".$thoigian."','".$tomtat."','".$noidung."','".$tinhtrang."','".$thutu."')";
